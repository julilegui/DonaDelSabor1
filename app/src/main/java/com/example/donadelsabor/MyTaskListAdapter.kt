                        ...
                        val info: Bundle): RecyclerView.Adapter<MyTaskListAdapter.MyViewHolder>()
{
    ...
    var myTaskContents:ArrayList<String> =info.getStringArrayList("content") as ArrayList<String>
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        var textViewContent=holder.layout.findViewById<TextView>(R.id.TextViewContent)
        textViewContent.text= myTaskContents[position]
        ...
        holder.layout.setOnClickListener{
            ...
            datos.putString("contenido", textViewContent.text as String)
